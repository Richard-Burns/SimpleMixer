# Simple Mixer
Simple Mixer is a real-time and video mixing tool built entirely in TouchDesigner. It currently works only in 099 build 20700. At some point in the near future it will be ported to the latest stable build.
